...
colors:
  dark:
    ...
    accent-hover: "#DEDFE0"
    accent-soft: "rgba(248, 248, 249, 0.15)"
    accent-soft-foreground: "#F8F8F9"
    danger: "#DB3B3E"
    success: "#17C964"
    warning: "#F7B750"
    border: "#28292A"
    ...
    snow: "#FCFCFC"
    white: "#FFFFFF"
    accent-soft-hover: "rgba(248, 248, 249, 0.2)"
...
| `accent-soft`                    | `rgba(43, 46, 49, 0.15)`   | `rgba(248, 248, 249, 0.15)` | `accent / 15% + transparent`                                                                                                                                                                  | `--accent-soft`                    | `bg-accent-soft text-accent-soft-foreground` for selected or soft emphasis | Subtle accent background. A low-opacity tint for soft emphasis and selections.      |
| `accent-soft-foreground`         | `#2B2E31`                  | `#F8F8F9`                   | `= accent`                                                                                                                                                                                    | `--accent-soft-foreground`         | Prefer the HeroUI token for accent-soft-foreground.                        | Text color on accent-soft backgrounds. Matches the accent color.                    |
...
| `accent-soft-hover`              | `rgba(43, 46, 49, 0.2)`    | `rgba(248, 248, 249, 0.2)`  | `accent / 20% + transparent`                                                                                                                                                                  | `--accent-soft-hover`              | Prefer the HeroUI token for accent-soft-hover.                             | Hover state for accent-soft backgrounds.                                            |
...
| --- | --- | --- | --- | --- | --- |
| `xs` | Figtree | `12px` | `16px` | `--text-xs` | `text-xs` |
| `sm` | Figtree | `14px` | `20px` | `--text-sm` | `text-sm` |
| `base` | Figtree | `16px` | `24px` | `--text-base` | `text-base` |
| `lg` | Figtree | `18px` | `28px` | `--text-lg` | `text-lg` |
| `xl` | Figtree | `20px` | `28px` | `--text-xl` | `text-xl` |
| `2xl` | Figtree | `24px` | `32px` | `--text-2xl` | `text-2xl` |
| `3xl` | Figtree | `30px` | `36px` | `--text-3xl` | `text-3xl` |
| `4xl` | Figtree | `36px` | `40px` | `--text-4xl` | `text-4xl` |
| `5xl` | Figtree | `48px` | `48px` | `--text-5xl` | `text-5xl` |
| `6xl` | Figtree | `60px` | `60px` | `--text-6xl` | `text-6xl` |
| `7xl` | Figtree | `72px` | `72px` | `--text-7xl` | `text-7xl` |
| `8xl` | Figtree | `96px` | `96px` | `--text-8xl` | `text-8xl` |
| `9xl` | Figtree | `128px` | `128px` | `--text-9xl` | `text-9xl` |

### Font and Letter Spacing

| Token              | Raw value             | Formula / source | HeroUI variable      | Tailwind / component equivalent                                                 | Purpose                                                                 |
| ------------------ | --------------------- | ---------------- | -------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `font sans`        | `var(--font-figtree)` |                  | `--font-sans`        | Prefer inherited typography from HeroUI components and Tailwind font utilities. | Primary sans font family used by HeroUI components.                     |
